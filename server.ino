      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.println("</tr>");
            client.println("<tr>");
            client.println("<th>"+imageWind+"</th>");
            client.println("<th>"+String(clientData.windSpeed)+" m/s</th>");
            client.println("</tr>");
